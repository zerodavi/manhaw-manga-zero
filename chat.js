...
function salvarNome(){
  ...
  const eraEdicao = nome !== null && canalAtivo !== null; // já estava no chat
  ...
  if(eraEdicao){
    // Só atualiza header — NÃO recria o canal (ele não depende do nome)
    document.getElementById("titulo").innerText = "Chat - " + nome;
    document.getElementById("headerAvatar").src = icone;
  } else {
    // Primeiro acesso: escolhe sala normalmente
    mostrarTelaSala();
  }
}
